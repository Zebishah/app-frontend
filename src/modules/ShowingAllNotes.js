...
const AllNotes = (props) => {
  ...
  return (
    <div className="flex flex-col gap-y-14 mt-10 items-center justify-center">
      ...
      <div className='flex flex-wrap items-center sm:justify-start smd:ml-8 xl:gap-x-[1.7rem] gap-y-8 lg:gap-x-[4.2rem] smd:gap-x-[2.6rem] ssm:gap-x-[1rem] md:ml-8 sm:ml-2 ssm:justify-center sssm:justify-center '>
