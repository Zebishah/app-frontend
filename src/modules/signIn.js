...
const SignIn = () => {
  ...
  return (
    <div className='overflow-hidden flex flex-col'>
      ...
      <div className=" flex flex-col m-auto items-center justify-center md:p-6 ssm:p-2 bg-white shadow-sm shadow-black w-[40%] h-[25rem] relative bottom-[18.6rem] md:w-[30rem] sm:w-[60%] ssm:w-[70%] sssm:w-[80%] sssm:-mt-8 sssm:h-[40%] sssm:justify-center">
